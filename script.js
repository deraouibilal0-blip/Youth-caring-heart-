...
function changeLanguage(language) {
  ...
  /* IMPORTANT:
     The website name is NOT translated.
     Only the content with data-key is translated.
  */
  document
  ...
  /* DO NOT CHANGE RTL.
     This prevents the previous black-screen/layout issue. */
